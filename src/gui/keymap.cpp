...
// This is the master key map that includes ANSI, ISO and JP-106 layouts - use
// patchANSI(), patchISO() or patchJP106() to finalize it
static const Key K95Keys[] = {
    {nullptr, nullptr, "mr", 38, 0, NS, true, true},
    {nullptr, nullptr, "m1", 50, 0, NS, true, true},
    {nullptr, nullptr, "m2", 62, 0, NS, true, true},
    {nullptr, nullptr, "m3", 74, 0, NS, true, true},
    {nullptr, "Brightness", "light", 222, 0, NS, true, true},
    {nullptr, "Windows Lock", "lock", 234, 0, NS, true, true},
    {nullptr, "Mute", "mute", 273, 0, 13, 8, true, true},
    {nullptr, "Volume Up", "volup", 290, -2, 18, 6, false, true},
    {nullptr, "Volume down", "voldn", 290, 2, 18, 6, false, true},
    {nullptr, nullptr, "g1", 0, 14, NS, true, true},
    {nullptr, nullptr, "g2", 11, 14, NS, true, true},
    {nullptr, nullptr, "g3", 22, 14, NS, true, true},
    {nullptr, "Esc", "esc", 38, 14, NS, true, true},
    {nullptr, nullptr, "f1", 58, 14, NS, true, true},
    {nullptr, nullptr, "f2", 70, 14, NS, true, true},
    {nullptr, nullptr, "f3", 82, 14, NS, true, true},
    {nullptr, nullptr, "f4", 94, 14, NS, true, true},
    {nullptr, nullptr, "f5", 114, 14, NS, true, true},
    {nullptr, nullptr, "f6", 126, 14, NS, true, true},
    {nullptr, nullptr, "f7", 138, 14, NS, true, true},
    {nullptr, nullptr, "f8", 150, 14, NS, true, true},
    {nullptr, nullptr, "f9", 170, 14, NS, true, true},
    {nullptr, nullptr, "f10", 182, 14, NS, true, true},
    {nullptr, nullptr, "f11", 194, 14, NS, true, true},
    {nullptr, nullptr, "f12", 206, 14, NS, true, true},
    {nullptr, "Print Screen\nSysRq", "prtscn", 222, 14, NS, true, true},
    {nullptr, "Scroll Lock", "scroll", 234, 14, NS, true, true},
    {nullptr, "Pause\nBreak", "pause", 246, 14, NS, true, true},
    {nullptr, "Stop", "stop", 262, 14, 12, 8, true, true},
    {nullptr, "Previous", "prev", 273, 14, 13, 8, true, true},
    {nullptr, "Play/Pause", "play", 285, 14, 13, 8, true, true},
    {nullptr, "Next", "next", 296, 14, 12, 8, true, true},
    {nullptr, nullptr, "g4", 0, 25, NS, true, true},
    {nullptr, nullptr, "g5", 11, 25, NS, true, true},
    {nullptr, nullptr, "g6", 22, 25, NS, true, true},
    {nullptr, "`", "grave", 38, 27, NS, true, true},
    {nullptr, nullptr, "1", 50, 27, NS, true, true},
    {nullptr, nullptr, "2", 62, 27, NS, true, true},
    {nullptr, nullptr, "3", 74, 27, NS, true, true},
    {nullptr, nullptr, "4", 86, 27, NS, true, true},
    {nullptr, nullptr, "5", 98, 27, NS, true, true},
    {nullptr, nullptr, "6", 110, 27, NS, true, true},
    {nullptr, nullptr, "7", 122, 27, NS, true, true},
    {nullptr, nullptr, "8", 134, 27, NS, true, true},
    {nullptr, nullptr, "9", 146, 27, NS, true, true},
    {nullptr, nullptr, "0", 158, 27, NS, true, true},
    {nullptr, "-", "minus", 170, 27, NS, true, true},
    {nullptr, "=", "equal", 182, 27, NS, true, true},
    {nullptr, "¥", "yen", 194, 27, NS, true, true},
    {nullptr, "Backspace", "bspace", 200, 27, 24, 12, true, true},
    {nullptr, "Insert", "ins", 222, 27, NS, true, true},
    {nullptr, "Home", "home", 234, 27, NS, true, true},
    {nullptr, "Page Up", "pgup", 246, 27, NS, true, true},
    {nullptr, "Num Lock", "numlock", 261, 27, NS, true, true},
    {nullptr, "NumPad /", "numslash", 273, 27, NS, true, true},
    {nullptr, "NumPad *", "numstar", 285, 27, NS, true, true},
    {nullptr, "NumPad -", "numminus", 297, 27, NS, true, true},
    {nullptr, nullptr, "g7", 0, 39, NS, true, true},
    {nullptr, nullptr, "g8", 11, 39, NS, true, true},
    {nullptr, nullptr, "g9", 22, 39, NS, true, true},
    {nullptr, "Tab", "tab", 41, 39, 18, 12, true, true},
    {nullptr, nullptr, "q", 56, 39, NS, true, true},
    {nullptr, nullptr, "w", 68, 39, NS, true, true},
    {nullptr, nullptr, "e", 80, 39, NS, true, true},
    {nullptr, nullptr, "r", 92, 39, NS, true, true},
    {nullptr, nullptr, "t", 104, 39, NS, true, true},
    {nullptr, nullptr, "y", 116, 39, NS, true, true},
    {nullptr, nullptr, "u", 128, 39, NS, true, true},
    {nullptr, nullptr, "i", 140, 39, NS, true, true},
    {nullptr, nullptr, "o", 152, 39, NS, true, true},
    {nullptr, nullptr, "p", 164, 39, NS, true, true},
    {nullptr, "[", "lbrace", 176, 39, NS, true, true},
    {nullptr, "]", "rbrace", 188, 39, NS, true, true},
    {nullptr, "\\", "bslash", 203, 39, 18, 12, true, true},
    {nullptr, "Enter", "enter", 203, 45, 18, 24, true, true},
    {nullptr, "Delete", "del", 222, 39, NS, true, true},
    {nullptr, "End", "end", 234, 39, NS, true, true},
    {nullptr, "Page Down", "pgdn", 246, 39, NS, true, true},
    {nullptr, "NumPad 7", "num7", 261, 39, NS, true, true},
    {nullptr, "NumPad 8", "num8", 273, 39, NS, true, true},
    {nullptr, "NumPad 9", "num9", 285, 39, NS, true, true},
    {nullptr, "NumPad +", "numplus", 297, 45, 12, 24, true, true},
    {nullptr, nullptr, "g10", 0, 50, NS, true, true},
    {nullptr, nullptr, "g11", 11, 50, NS, true, true},
    {nullptr, nullptr, "g12", 22, 50, NS, true, true},
    {nullptr, "Caps Lock", "caps", 42, 51, 20, 12, true, true},
    {nullptr, nullptr, "a", 59, 51, NS, true, true},
    {nullptr, nullptr, "s", 71, 51, NS, true, true},
    {nullptr, nullptr, "d", 83, 51, NS, true, true},
    {nullptr, nullptr, "f", 95, 51, NS, true, true},
    {nullptr, nullptr, "g", 107, 51, NS, true, true},
    {nullptr, nullptr, "h", 119, 51, NS, true, true},
    {nullptr, nullptr, "j", 131, 51, NS, true, true},
    {nullptr, nullptr, "k", 143, 51, NS, true, true},
    {nullptr, nullptr, "l", 155, 51, NS, true, true},
    {nullptr, ";", "colon", 167, 51, NS, true, true},
    {nullptr, "'", "quote", 179, 51, NS, true, true},
    {nullptr, "#", "hash", 191, 51, NS, true, true},
    {nullptr, "NumPad 4", "num4", 261, 51, NS, true, true},
    {nullptr, "NumPad 5", "num5", 273, 51, NS, true, true},
    {nullptr, "NumPad 6", "num6", 285, 51, NS, true, true},
    {nullptr, nullptr, "g13", 0, 64, NS, true, true},
    {nullptr, nullptr, "g14", 11, 64, NS, true, true},
    {nullptr, nullptr, "g15", 22, 64, NS, true, true},
    {nullptr, "Left Shift", "lshift", 39, 63, 14, 12, true, true},
    {"bslash", "\\", "bslash_iso", 53, 63, NS, true, true},
    {nullptr, nullptr, "z", 65, 63, NS, true, true},
    {nullptr, nullptr, "x", 77, 63, NS, true, true},
    {nullptr, nullptr, "c", 89, 63, NS, true, true},
    {nullptr, nullptr, "v", 101, 63, NS, true, true},
    {nullptr, nullptr, "b", 113, 63, NS, true, true},
    {nullptr, nullptr, "n", 125, 63, NS, true, true},
    {nullptr, nullptr, "m", 137, 63, NS, true, true},
    {nullptr, ",", "comma", 149, 63, NS, true, true},
    {nullptr, ".", "dot", 161, 63, NS, true, true},
    {nullptr, "/", "slash", 173, 63, NS, true, true},
    {nullptr, "_", "ro", 185, 63, NS, true, true},
    {nullptr, "Right Shift", "rshift", 196, 63, 32, 12, true, true},
    {nullptr, "Up", "up", 234, 63, NS, true, true},
    {nullptr, "NumPad 1", "num1", 261, 63, NS, true, true},
    {nullptr, "NumPad 2", "num2", 273, 63, NS, true, true},
    {nullptr, "NumPad 3", "num3", 285, 63, NS, true, true},
    {nullptr, "NumPad Enter", "numenter", 297, 69, 12, 24, true, true},
    {nullptr, nullptr, "g16", 0, 75, NS, true, true},
    {nullptr, nullptr, "g17", 11, 75, NS, true, true},
    {nullptr, nullptr, "g18", 22, 75, NS, true, true},
    {nullptr, "Left Ctrl", "lctrl", 40, 75, 16, 12, true, true},
    {nullptr, "Left Windows", "lwin", 54, 75, NS, true, true},
    {nullptr, "Left Alt", "lalt", 67, 75, 14, 12, true, true},
    {nullptr, "無変換", "muhenkan", 80, 75, NS, true, true},
    {nullptr, "Space", "space", 116, 75, 84, 12, true, true},
    {nullptr, "変換", "henkan", 150, 75, NS, true, true},
    {nullptr, "ひらがな カタカナ ローマ字", "katahira", 162, 75, NS, true,
     true},
    {nullptr, "Right Alt", "ralt", 165, 75, 14, 12, true, true},
    {nullptr, "Right Windows", "rwin", 178, 75, NS, true, true},
    {nullptr, "Menu", "rmenu", 190, 75, NS, true, true},
    {nullptr, "Right Ctrl", "rctrl", 204, 75, 16, 12, true, true},
    {nullptr, "Left", "left", 222, 75, NS, true, true},
    {nullptr, "Down", "down", 234, 75, NS, true, true},
    {nullptr, "Right", "right", 246, 75, NS, true, true},
    {nullptr, "NumPad 0", "num0", 267, 75, 24, 12, true, true},
    {nullptr, "NumPad .", "numdot", 285, 75, NS, true, true}};
...
static const KeyPatch patchDK[] = {
    {nullptr, "§", "grave"},      {nullptr, "+", "minus"},
    {nullptr, "´", "equal"},      {nullptr, "Å", "lbrace"},
    {nullptr, "¨", "rbrace"},     {nullptr, "Æ", "colon"},
    {nullptr, "Ø", "quote"},      {nullptr, "'", "hash"},
...
static const KeyPatch patchDE[] = {
    {"caret", "^", "grave"},      {"ss", "ß", "minus"},
    {"grave", "´", "equal"},      {"z", "Z", "y"},
    {"ue", "Ü", "lbrace"},        {"plus", "+", "rbrace"},
    {"oe", "Ö", "colon"},         {"ae", "Ä", "quote"},
    {"angle", "<", "bslash_iso"}, {"y", "Y", "z"},
    {"minus", "-", "slash"}};

static const KeyPatch patchIT[] = {
    {nullptr, "\\", "grave"},     {nullptr, "'", "minus"},
    {nullptr, "Ì", "equal"},      {nullptr, "È", "lbrace"},
    {nullptr, "+", "rbrace"},     {nullptr, "Ò", "colon"},
    {nullptr, "À", "quote"},      {nullptr, "Ù", "hash"},
    {nullptr, "<", "bslash_iso"}, {nullptr, "-", "slash"},
};
...
static const KeyPatch patchNO[] = {
    {nullptr, "§", "grave"},      {nullptr, "+", "minus"},
    {nullptr, "´", "equal"},      {nullptr, "Å", "lbrace"},
    {nullptr, "¨", "rbrace"},     {nullptr, "Ø", "colon"},
    {nullptr, "Æ", "quote"},      {nullptr, "'", "hash"},
    {nullptr, "<", "bslash_iso"}, {nullptr, "-", "slash"},
};

static const KeyPatch patchMX[] = {
    {nullptr, "|", "grave"},      {nullptr, "'", "minus"},
    {nullptr, "¿", "equal"},      {nullptr, "´", "lbrace"},
    {nullptr, "+", "rbrace"},     {nullptr, "Ñ", "colon"},
    {nullptr, "{", "quote"},      {nullptr, "}", "hash"},
    {nullptr, "<", "bslash_iso"}, {nullptr, "-", "slash"},
};

static const KeyPatch patchPTBR[] = {
    {"quote", "'", "grave"},     {"accent", "´", "lbrace"},
    {"lbrace", "[", "rbrace"},   {"cc", "Ç", "colon"},
    {"tilde", "~", "quote"},     {"rbrace", "]", "hash"},
    {"colon", ";", "slash"},     {"slash", "/", "ro"},
    {"numcomma", ",", "numdot"},
};

static const KeyPatch patchES[] = {
    {"oa", "º", "grave"},         {"quote", "'", "minus"},
    {"lexclam", "¡", "equal"},    {"grave", "`", "lbrace"},
    {"plus", "+", "rbrace"},      {"nn", "Ñ", "colon"},
    {"accent", "´", "quote"},     {"cc", "Ç", "hash"},
    {"angle", "<", "bslash_iso"}, {"minus", "-", "slash"},
};

static const KeyPatch patchSE[] = {
    {"section", "§", "grave"},    {"plus", "+", "minus"},
    {"grave", "´", "equal"},      {"aa", "Å", "lbrace"},
    {"umlaut", "¨", "rbrace"},    {"oe", "Ö", "colon"},
    {"ae", "Ä", "quote"},         {"quote", "'", "hash"},
    {"angle", "<", "bslash_iso"}, {"minus", "-", "slash"},
};
...
static const KeyPatch patchDvorak[] = {
    {nullptr, "[", "minus"},  {nullptr, "]", "equal"},  {nullptr, "'", "q"},
    {nullptr, ",", "w"},      {nullptr, ".", "e"},      {nullptr, "P", "r"},
    {nullptr, "Y", "t"},      {nullptr, "F", "y"},      {nullptr, "G", "u"},
    {nullptr, "C", "i"},      {nullptr, "R", "o"},      {nullptr, "L", "p"},
    {nullptr, "/", "lbrace"}, {nullptr, "=", "rbrace"}, {nullptr, "O", "s"},
    {nullptr, "E", "d"},      {nullptr, "U", "f"},      {nullptr, "I", "g"},
    {nullptr, "D", "h"},      {nullptr, "H", "j"},      {nullptr, "T", "k"},
    {nullptr, "N", "l"},      {nullptr, "S", "colon"},  {nullptr, "-", "quote"},
    {nullptr, ";", "z"},      {nullptr, "Q", "x"},      {nullptr, "J", "c"},
    {nullptr, "K", "v"},      {nullptr, "X", "b"},      {nullptr, "B", "n"},
    {nullptr, "W", "comma"},  {nullptr, "V", "dot"},    {nullptr, "Z", "slash"},
};
...
static void _patch(QHash<QString, Key> &map, const KeyPatch *patches,
                   int patchCount) {
...
// Used to fix the Fn size and remove Alt when necessary in JP layouts for
// compatible devices
...
static const Key K70TklTopRow[] = {
    ...
    {nullptr, "Profile Switch", "profswitch", 178 - K70_X_START, 0, 12, 8, true,
     true},
...
static const Key K68TopRow[] = {
    {nullptr, "Volume Down", "voldn", 285 - K70_X_START, 0, 13, 8, true, true},
    {nullptr, "Volume Up", "volup", 297 - K70_X_START, 0, 13, 8, true, true},
};
#define K68_TOP_COUNT (sizeof(K68TopRow) / sizeof(Key))

static const Key K65TopRow[] = {
    {nullptr, "Brightness", "light", 164 - K70_X_START, 0, 12, 12, true, true},
    {nullptr, "Mute", "mute", 176 - K70_X_START, 0, 12, 12, true, true},
    {nullptr, "Volume Down", "voldn", 192 - K70_X_START, 0, 14, 8, true, true},
    {nullptr, "Volume Up", "volup", 205 - K70_X_START, 0, 14, 8, true, true},
    {nullptr, "Windows Lock", "lock", 222 - K70_X_START, 0, 12, 12, true,
     true}};
...
static const Key K63TopRow[] = {
    ...
    {nullptr, "Play/Pause", "play", K70_X_START - 15, 0, 12, 8, true, true},
    {nullptr, "Next", "next", K70_X_START - 4, 0, 12, 8, true, true},
    {nullptr, "Brightness", "light", 170 - K70_X_START, 0, 12, 12, true, true},
    {nullptr, "Windows Lock", "lock", 180 - K70_X_START, 0, 12, 12, true, true},
    {nullptr, "Mute", "mute", 222 - K70_X_START, 0, 13, 8, true, true},
    {nullptr, "Volume Down", "voldn", 234 - K70_X_START, 0, 13, 8, true, true},
    {nullptr, "Volume Up", "volup", 246 - K70_X_START, 0, 13, 8, true, true}};
...
static const Key KStrafeKeys[] = {
    {nullptr, "Sidelight", "lsidel", 0, KSTRAFE_HEIGHT / 2, KSTRAFE_X_START,
     KSTRAFE_HEIGHT, true, false},
    {nullptr, "Sidelight", "rsidel", KSTRAFE_WIDTH, KSTRAFE_HEIGHT / 2,
     KSTRAFE_X_START, KSTRAFE_HEIGHT, true, false},
    {nullptr, "Logo", "logo", KSTRAFE_X_START, 0, NS, true, false},
    {nullptr, "Function", "fn", 152, 75, NS, true, true}};

// Mouse map - M65
static const Key M65Keys[] = {
    {nullptr, "Left Mouse", "mouse1", 8, 0, 14, 32, false, true},
    {nullptr, "Right Mouse", "mouse2", 30, 0, 14, 32, false, true},
    {nullptr, "Middle Mouse", "mouse3", 22, 8, 8, 7, false, true},
    {nullptr, "Wheel Up", "wheelup", 22, 4, 8, 5, false, true},
    {nullptr, "Wheel Down", "wheeldn", 22, 14, 8, 5, false, true},
    {nullptr, "Wheel Light", "front", 22, 15, 8, 8, true, false},
    {nullptr, "DPI Up", "dpiup", 22, 19, 8, 6, false, true},
    {nullptr, "DPI Light", "dpi", 22, 24, 8, 8, true, false},
    {nullptr, "DPI Down", "dpidn", 22, 31, 8, 6, false, true},
    {nullptr, "Forward", "mouse5", 5, 24, 5, 9, false, true},
    {nullptr, "Back", "mouse4", 5, 33, 5, 10, false, true},
    {nullptr, "Sniper", "sniper", 0, 25, 5, 15, false, true},
...
static const Key SabreKeys[] = {
    {nullptr, "Left Mouse", "mouse1", 8, 0, 14, 32, false, true},
    {nullptr, "Right Mouse", "mouse2", 30, 0, 14, 32, false, true},
    {nullptr, "Middle Mouse", "mouse3", 22, 9, 8, 7, false, true},
    {nullptr, "Front light", "front", 8, -2, 14, 8, true, false},
    {nullptr, "Wheel Up", "wheelup", 22, 5, 8, 5, false, true},
    {nullptr, "Wheel Down", "wheeldn", 22, 15, 8, 5, false, true},
    {nullptr, "Wheel Light", "wheel", 22, 5, 8, 15, true, false},
    {nullptr, "Extra button", "thumb1", 22, 20, 8, 18, false, true},
    {nullptr, "DPI Up", "dpiup", 5, 3, 5, 7, false, true},
    {nullptr, "DPI Down", "dpidn", 5, 10, 5, 7, false, true},
    {nullptr, "DPI Light", "dpi", 5, 4, 5, 12, true, false},
    {nullptr, "Forward", "mouse5", 5, 24, 5, 9, false, true},
    {nullptr, "Back", "mouse4", 5, 33, 5, 10, false, true},
...
static const Key HarpoonKeys[] = {
    {nullptr, "Left Mouse", "mouse1", 10, 5, 14, 26, false, true},
    {nullptr, "Right Mouse", "mouse2", 30, 5, 14, 26, false, true},
    {nullptr, "Middle Mouse", "mouse3", 25, 11, 6, 7, false, true},
    {nullptr, "Wheel Up", "wheelup", 25, 7, 6, 5, false, true},
    {nullptr, "Wheel Down", "wheeldn", 25, 17, 6, 5, false, true},
    {nullptr, "DPI Cycle", "dpiup", 25, 23, 6, 10, false, true},
    {nullptr, "Logo Light", "dpi", 18, 40, 20, 20, true, false},
...
static const Key GlaiveKeys[] = {
    {nullptr, "Left Mouse", "mouse1", 17, 3, 14, 18, false, true},
    {nullptr, "Right Mouse", "mouse2", 37, 3, 14, 18, false, true},
    {nullptr, "Middle Mouse", "mouse3", 31, 9, 7, 7, false, true},
    {nullptr, "Front light", "front", 16, -5, 36, 8, true, false},
    {nullptr, "Wheel Up", "wheelup", 31, 5, 7, 5, false, true},
    {nullptr, "Wheel Down", "wheeldn", 31, 15, 7, 5, false, true},
    {nullptr, "Side Lights", "side", 22, 24, 7, 20, true, false},
    {nullptr, "DPI Cycle", "dpiup", 31, 19, 6, 12, false, true},
    {nullptr, "Logo Light", "back", 26, 45, 16, 16, true, false},
    {nullptr, "Forward", "mouse5", 15, 22, 5, 11, false, true},
    {nullptr, "Back", "mouse4", 15, 32, 5, 11, false, true}};
...
static const Key KatarKeys[] = {
    ...
    {nullptr, "Logo Light", "front", 15, 43, 20, 20, true, false},
};
...
static const Key ScimKeys[] = {
    {nullptr, "Left Mouse", "mouse1", 15, 0, 14, 32, false, true},
    {nullptr, "Right Mouse", "mouse2", 37, 0, 12, 32, false, true},
    {nullptr, "Middle Mouse", "mouse3", 29, 9, 8, 6, false, true},
    {nullptr, "Front light", "front", 37, 0, 12, 8, true, false},
    {nullptr, "Wheel Up", "wheelup", 29, 3, 8, 6, false, true},
    {nullptr, "Wheel Down", "wheeldn", 29, 14, 8, 6, false, true},
    {nullptr, "Wheel Light", "wheel", 29, 3, 8, 17, true, false},
    {nullptr, "DPI Up", "dpiup", 29, 19, 8, 9, false, true},
    {nullptr, "DPI Light", "dpi", 8, 12, 8, 4, true, false},
    {nullptr, "DPI Down", "dpidn", 29, 28, 8, 9, false, true},
    {nullptr, "Thumb light", "thumb", 7, 21, 10, 24, true, false},
    {nullptr, "1", "thumb1", -6, 18, 7, 7, false, true},
    {nullptr, "2", "thumb2", 1, 18, 7, 7, false, true},
    {nullptr, "3", "thumb3", 8, 18, 7, 7, false, true},
    {nullptr, "4", "thumb4", -6, 25, 7, 7, false, true},
    {nullptr, "5", "thumb5", 1, 25, 7, 7, false, true},
    {nullptr, "6", "thumb6", 8, 25, 7, 7, false, true},
    {nullptr, "7", "thumb7", -6, 32, 7, 7, false, true},
    {nullptr, "8", "thumb8", 1, 32, 7, 7, false, true},
    {nullptr, "9", "thumb9", 8, 32, 7, 7, false, true},
    {nullptr, "10", "thumb10", -6, 39, 7, 7, false, true},
    {nullptr, "11", "thumb11", 1, 39, 7, 7, false, true},
    {nullptr, "12", "thumb12", 8, 39, 7, 7, false, true},
...
static const Key M95Keys[] = {
    {nullptr, "Left Mouse", "mouse1", 42, 6, 14, 26, false, true},
    {nullptr, "Right Mouse", "mouse2", 63, 6, 14, 26, false, true},
    {nullptr, "Middle Mouse", "mouse3", 55, 8, 8, 7, false, true},
    {nullptr, "4", "thumb6", 56, 28, 7, 12, false, true},
    {nullptr, "Wheel Up", "wheelup", 55, 4, 8, 5, false, true},
    {nullptr, "Wheel Down", "wheeldn", 55, 14, 8, 5, false, true},
    {nullptr, "DPI Up (5)", "dpiup", 38, -1, 6, 9, false, true},
    {nullptr, "DPI Down (6)", "dpidn", 38, 6, 6, 9, false, true},
    {nullptr, "Forward (7)", "mouse6", -9, 14, 14, 8, false, true},
    {nullptr, "Back (8)", "mouse7", 3, 14, 14, 8, false, true},
    {nullptr, "Sniper (14)", "sniper", -6, 20, 8, 14, false, true},
    {nullptr, "9", "thumb1", 15, 14, 18, 8, false, true},
    {nullptr, "15", "thumb7", 15, 20, 10, 22, false, true},
    {nullptr, "10", "thumb2", 23, 20, 10, 12, false, true},
    {nullptr, "11", "thumb3", 23, 30, 10, 12, false, true},
    {nullptr, "12", "thumb4", 15, 40, 18, 8, false, true},
    {nullptr, "13", "thumb5", -1, 40, 18, 8, false, true},
...
static const Key K95PLbar[] = {
    {nullptr, "Top Light Bar 1", "topbar1", 4, -3, LBS, true, false},
    {nullptr, "Top Light Bar 2", "topbar2", 19, -3, LBS, true, false},
    {nullptr, "Top Light Bar 3", "topbar3", 34, -3, LBS, true, false},
    {nullptr, "Top Light Bar 4", "topbar4", 49, -3, LBS, true, false},
    {nullptr, "Top Light Bar 5", "topbar5", 64, -3, LBS, true, false},
    {nullptr, "Top Light Bar 6", "topbar6", 79, -3, LBS, true, false},
    {nullptr, "Top Light Bar 7", "topbar7", 94, -3, LBS, true, false},
    {nullptr, "Top Light Bar 8", "topbar8", 109, -3, LBS, true, false},
    {nullptr, "Top Light Bar 9", "topbar9", 124, -3, LBS, true, false},
    {nullptr, "Top Light Bar 10", "topbar10", 139, -3, LBS, true, false},
    {nullptr, "Top Light Bar 11", "topbar11", 154, -3, LBS, true, false},
    {nullptr, "Top Light Bar 12", "topbar12", 169, -3, LBS, true, false},
    {nullptr, "Top Light Bar 13", "topbar13", 184, -3, LBS, true, false},
    {nullptr, "Top Light Bar 14", "topbar14", 199, -3, LBS, true, false},
    {nullptr, "Top Light Bar 15", "topbar15", 214, -3, LBS, true, false},
    {nullptr, "Top Light Bar 16", "topbar16", 229, -3, LBS, true, false},
    {nullptr, "Top Light Bar 17", "topbar17", 244, -3, LBS, true, false},
    {nullptr, "Top Light Bar 18", "topbar18", 259, -3, LBS, true, false},
...
static const Key DarkCoreKeys[] = {
    ...
    {nullptr, "Wheel Up", "wheelup", 22, 4, 8, 5, false, true},
    {nullptr, "Wheel Down", "wheeldn", 22, 14, 8, 5, false, true},
    {nullptr, "Wheel Light", "wheel", 22, 2, 8, 16, true, false},
    {nullptr, "DPI Up", "dpiup", 0, 5, 8, 8, false, true},
    {nullptr, "DPI Down", "dpidn", 0, 12, 8, 8, false, true},
    {nullptr, "Forward", "mouse5", 5, 24, 5, 9, false, true},
    {nullptr, "Back", "mouse4", 5, 33, 5, 10, false, true},
    {nullptr, "Sniper", "sniper", 0, 25, 5, 15, false, true},
    {nullptr, "Side light", "side", 0, 24, 10, 24, true, false},
    {nullptr, "Logo", "back", 19, 50, 12, 12, true, false},
    {nullptr, "Profile Switch", "profswitch", 22, 20, 8, 12, false, true},
    {nullptr, "DPI", "dpi", 0, 0, 10, 24, true, false}};
...
static const Key PolarisZones[] = {
    {nullptr, "Zone 1", "zone1", 65, 4, POLARIS_V, true, false},
    {nullptr, "Zone 2", "zone2", 65, 16, POLARIS_V, true, false},
    {nullptr, "Zone 3", "zone3", 65, 28, POLARIS_V, true, false},
    {nullptr, "Zone 4", "zone4", 65, 40, POLARIS_V, true, false},
    {nullptr, "Zone 5", "zone5", 65, 52, POLARIS_V, true, false},
    {nullptr, "Zone 6", "zone6", 43, 62, POLARIS_H, true, false},
    {nullptr, "Zone 7", "zone7", 31, 62, POLARIS_H, true, false},
    {nullptr, "Zone 8", "zone8", 19, 62, POLARIS_H, true, false},
    {nullptr, "Zone 9", "zone9", 7, 62, POLARIS_H, true, false},
    {nullptr, "Zone 10", "zone10", -5, 62, POLARIS_H, true, false},
    {nullptr, "Zone 11", "zone11", -19, 52, POLARIS_V, true, false},
    {nullptr, "Zone 12", "zone12", -19, 40, POLARIS_V, true, false},
    {nullptr, "Zone 13", "zone13", -19, 28, POLARIS_V, true, false},
    {nullptr, "Zone 14", "zone14", -19, 16, POLARIS_V, true, false},
    {nullptr, "Zone 15", "zone15", -19, 4, POLARIS_V, true, false}};
...
static const Key ST100Zones[] = {
    {nullptr, "Zone 1", "zone1", 16, 10, ST100_H, true, false},
    {nullptr, "Zone 2", "zone2", 36, 10, ST100_H, true, false},
    {nullptr, "Zone 3", "zone3", 52, 30, ST100_V, true, false},
    {nullptr, "Zone 4", "zone4", 52, 50, ST100_V, true, false},
    {nullptr, "Logo", "zone5", 21, -1, NS, true, false}, // Logo
    {nullptr, "Zone 6", "zone6", 16, 66, ST100_H, true, false},
    {nullptr, "Zone 7", "zone7", -4, 50, ST100_V, true, false},
    {nullptr, "Zone 8", "zone8", -4, 30, ST100_V, true, false},
...
static const Key IronclawKeys[] = {
    ...
    // need to add DPI LED, even if not directly configurable for indicator to
    // work
...
static const Key NightswordKeys[] = {
    ...
    {nullptr, "Back light", "side", 12, 64, 36, 8, true,
     false}, // Addition; side == bottom, under logo
    {nullptr, "DPI Light", "dpi", 6, 11, 5, 12, true,
     false}, // thumb side DPI indicator light
    // DPI keys
...
// Map getter. Each model/layout pair only needs to be constructed once; after
// that, future KeyMaps can copy the existing maps.
...
static QHash<QString, Key> getMap(KeyMap::Model model, KeyMap::Layout layout) {
  ...
  case KeyMap::K95L: {
    ...
    const Key lghtpgm = {
        nullptr, "Lighting Programming", "lghtpgm", 210, 0, NS, true, true};
  ...
  case KeyMap::K95P: {
    ...
    // Add profile button
    map["profswitch"] = {
        nullptr, "Profile Switch", "profswitch", 64, 1, 11, 8, true, true};
  ...
  case KeyMap::K100: {
    ...
    map["topbar20"] = {
        nullptr, "Top Light Bar 20", "topbar20", 255, -3, 15, 6, true, false};
    map["topbar21"] = {
        nullptr, "Top Light Bar 21", "topbar21", 268, -3, 15, 6, true, false};
    map["topbar22"] = {
        nullptr, "Top Light Bar 22", "topbar22", 281, -3, 15, 6, true, false};

    // Add the left and right bars
    map["leftbar1"] = {
        nullptr, "Left Light Bar 1", "leftbar1", -2, -2, 6, 9, true, false};
    map["leftbar2"] = {
        nullptr, "Left Light Bar 2", "leftbar2", -2, 7, 6, 9, true, false};
    map["leftbar3"] = {
        nullptr, "Left Light Bar 3", "leftbar3", -2, 16, 6, 9, true, false};
    map["leftbar4"] = {
        nullptr, "Left Light Bar 4", "leftbar4", -2, 25, 6, 9, true, false};
    map["leftbar5"] = {
        nullptr, "Left Light Bar 5", "leftbar5", -2, 34, 6, 9, true, false};
    map["leftbar6"] = {
        nullptr, "Left Light Bar 6", "leftbar6", -2, 43, 6, 9, true, false};
    map["leftbar7"] = {
        nullptr, "Left Light Bar 7", "leftbar7", -2, 52, 6, 9, true, false};
    map["leftbar8"] = {
        nullptr, "Left Light Bar 8", "leftbar8", -2, 61, 6, 9, true, false};
    map["leftbar9"] = {
        nullptr, "Left Light Bar 9", "leftbar9", -2, 70, 6, 9, true, false};
    map["leftbar10"] = {
        nullptr, "Left Light Bar 10", "leftbar10", -2, 79, 6, 9, true, false};
    map["leftbar11"] = {
        nullptr, "Left Light Bar 11", "leftbar11", -2, 88, 6, 9, true, false};

    map["rightbar1"] = {
        nullptr, "Right Light Bar 1", "rightbar1", 292, -2, 6, 9, true, false};
    map["rightbar2"] = {
        nullptr, "Right Light Bar 2", "rightbar2", 292, 7, 6, 9, true, false};
    map["rightbar3"] = {
        nullptr, "Right Light Bar 3", "rightbar3", 292, 16, 6, 9, true, false};
    map["rightbar4"] = {
        nullptr, "Right Light Bar 4", "rightbar4", 292, 25, 6, 9, true, false};
    map["rightbar5"] = {
        nullptr, "Right Light Bar 5", "rightbar5", 292, 34, 6, 9, true, false};
    map["rightbar6"] = {
        nullptr, "Right Light Bar 6", "rightbar6", 292, 43, 6, 9, true, false};
    map["rightbar7"] = {
        nullptr, "Right Light Bar 7", "rightbar7", 292, 52, 6, 9, true, false};
    map["rightbar8"] = {
        nullptr, "Right Light Bar 8", "rightbar8", 292, 61, 6, 9, true, false};
    map["rightbar9"] = {
        nullptr, "Right Light Bar 9", "rightbar9", 292, 70, 6, 9, true, false};
    map["rightbar10"] = {
        nullptr, "Right Light Bar 10", "rightbar10", 292, 79, 6, 9, true,
        false};
    map["rightbar11"] = {
        nullptr, "Right Light Bar 11", "rightbar11", 292, 88, 6, 9, true,
        false};
    ...
    map["ctrlwheel1"] = {
        nullptr, "Control Wheel 22.5°", "ctrlwheel1", 60 + 2, 10, 8, 6, true,
        false};
    map["ctrlwheel2"] = {nullptr,
                         "Control Wheel 67.5°",
                         "ctrlwheel2",
                         60 + 3,
                         10 + 1,
    ...
    map["ctrlwheel5"] = {nullptr,
                         ...
                         false};
    map["ctrlwheel6"] = {
        nullptr, "Control Wheel 247.5°", "ctrlwheel6", 60, 10 + 2, 5, 8, true,
        false};
    map["ctrlwheel7"] = {
        nullptr, "Control Wheel 292.5°", "ctrlwheel7", 60, 10 + 1, 5, 8, true,
        false};
    map["ctrlwheel8"] = {
        nullptr, "Control Wheel 337.5°", "ctrlwheel8", 60 + 1, 10, 8, 6, true,
        false};

    map["logoleft"] = {nullptr, "Logo Left", "logoleft", 134,  10,
                       10,      10,          true,       false};
    map["logo"] = {nullptr, "Logo", "logo", 144, 10, 10, 10, true, false};
    map["logoright"] = {nullptr, "Logo Right", "logoright", 154,  10,
                        10,      10,           true,        false};
  ...
  case KeyMap::K100_AIR: {
    map = getMap(KeyMap::K100, layout);

    // Remove side G-keys
    for (int j = 1; j <= 6; j++)
      map.remove(QString("g%1").arg(j));

    // Remove lightbars (K100 Air doesn't have the RGB edge)
    for (int j = 1; j <= 19; j++)
      map.remove(QString("topbar%1").arg(j));

    // Add Top G-Keys above Numpad aligned with NumLock, /, *, -
    // Assuming standard layout y=14 for top keys (adjust if needed, maybe 4?)
    // Using existing key coordinates for alignment
    short y_pos = 14;
    map["g1"] = {nullptr, "G1", "g1", (short)map["numlock"].x,
                 y_pos,   NS,   true, true};
    map["g2"] = {nullptr, "G2", "g2", (short)map["numslash"].x,
                 y_pos,   NS,   true, true};
    map["g3"] = {nullptr, "G3", "g3", (short)map["numstar"].x,
                 y_pos,   NS,   true, true};
    map["g4"] = {nullptr, "G4", "g4", (short)map["numminus"].x,
                 y_pos,   NS,   true, true};

    break;
  }
  case KeyMap::K70: {
    // The K70 maps are based on the K95 maps. However all the keys are
    // shifted left and the G keys are removed
    map = getMap(KeyMap::K95, layout);
    QMutableHashIterator<QString, Key> i(map);
    while (i.hasNext()) {
      i.next();
  ...
  case KeyMap::K70MK2: {
    // Same as K70 but buttons moved to the left, profswitch, and two logo
    // lights (using m3, g11)
    map = getMap(KeyMap::K70, layout);
    // Starting from the right of F2
    // Add profswitch
    map["profswitch"] = {
        nullptr, "Profile Switch", "profswitch", 40, 0, 10, 8, true, true};
  ...
  case KeyMap::K70_TKL: {
    ...
    for (const Key *key = K70TklTopRow; key < K70TklTopRow + K70_TKL_TOP_COUNT;
         key++)
      map[key->name] = *key;
  ...
  case KeyMap::K70_CORE_RGB: {
    map = getMap(KeyMap::K70, layout);
    map["lock"] = {nullptr, "Lock", "lock", 20,
                   2,       NS,     false,  true}; // F1 alternate
    map["profswitch"] = {
        nullptr, "Profile Switch", "profswitch", 32, 2, 11, 11, false,
        true}; // F2 alternate
    map["light"] = {nullptr, "Light", "light", 50,
                    2,       NS,      false,   true}; // F3 and F4 alternate
    map["stop"] = {nullptr, "Stop", "stop", 76,  2,
                   11,      11,     false,  true}; // F5 alternate
    map["prev"] = {nullptr, "Previous", "prev", 88,  2,
                   11,      11,         false,  true}; // F6 alternate
    map["play"] = {nullptr, "Play", "play", 100, 2,
                   11,      11,     false,  true}; // F7 alternate
    map["next"] = {nullptr, "Next", "next", 112, 2,
                   11,      11,     false,  true}; // F8 alternate
    map["ctrlwheelb"] = {nullptr, "Wheel", "ctrlwheelb", 168,
                         2,       NS,      false,        true}; // F12 alternate

    // This is the media button that defaults to play
    // We already have a play Fn button so we want to map it to something else
  ...
  case KeyMap::K57_WL: {
    ...
    map["voldn"] = {nullptr,
                    "Volume Down",
                    "voldn",
                    static_cast<short>(map["mute"].x + 12),
                    0,
                    map["mute"].width,
                    map["mute"].height,
                    true,
    ...
    map["volup"] = {nullptr,
                    "Volume Up",
                    "volup",
                    static_cast<short>(map["mute"].x + 24),
                    0,
                    map["mute"].width,
                    map["mute"].height,
                    true,
  ...
  case KeyMap::M65: {
    ...
    for (const Key *key = M65Keys; key < M65Keys + KEYCOUNT_M65; key++) {
      // Keyboard keys are written from the center because that's where the
      // LEDs are, but the mouse buttons are odd shapes so they're written
      // from the upper left
  ...
  case KeyMap::HARPOON: {
    // Harpoon mouse
    for (const Key *key = HarpoonKeys; key < HarpoonKeys + KEYCOUNT_HARPOON;
         key++) {
      Key translatedKey = *key;
      translatedKey.x += translatedKey.width / 2;
      translatedKey.y += translatedKey.height / 2;
  ...
  case KeyMap::GLAIVE: {
    // Glaive mouse
    for (const Key *key = GlaiveKeys; key < GlaiveKeys + KEYCOUNT_GLAIVE;
         key++) {
      Key translatedKey = *key;
      translatedKey.x += translatedKey.width / 2;
      translatedKey.y += translatedKey.height / 2;
  ...
  case KeyMap::KATARPROXT: {
    // Katar
    for (const Key *key = KatarPROXTKeys;
         key < KatarPROXTKeys + KEYCOUNT_KATAR_PROXT; key++) {
      Key translatedKey = *key;
      translatedKey.x += translatedKey.width / 2;
      translatedKey.y += translatedKey.height / 2;
      map[key->name] = translatedKey;
  ...
  case KeyMap::DARKCORE: {
    // Dark Core
    for (const Key *key = DarkCoreKeys; key < DarkCoreKeys + KEYCOUNT_DARKCORE;
         key++) {
      Key translatedKey = *key;
      translatedKey.x += translatedKey.width / 2;
      translatedKey.y += translatedKey.height / 2;
  ...
  case KeyMap::DARKCORERGBPRO: {
    // Dark Core
    for (const Key *key = DarkCoreRgbProKeys;
         key < DarkCoreRgbProKeys + KEYCOUNT_DARKCORERGBPRO; key++) {
      Key translatedKey = *key;
      translatedKey.x += translatedKey.width / 2;
      translatedKey.y += translatedKey.height / 2;
      map[key->name] = translatedKey;
  ...
  case KeyMap::POLARIS: {
    ...
    for (const Key *key = PolarisZones; key < PolarisZones + KEYCOUNT_POLARIS;
         key++) {
      Key translatedKey = *key;
      translatedKey.x += translatedKey.width / 2;
      translatedKey.y += translatedKey.height / 2;
  ...
  case KeyMap::MM700: {
    // MM700 Mousepad
    for (const Key *key = MM700Zones; key < MM700Zones + KEYCOUNT_MM700;
         key++) {
      Key translatedKey = *key;
      translatedKey.x += translatedKey.width / 2;
      translatedKey.y += translatedKey.height / 2;
  ...
  case KeyMap::ST100: {
    for (const Key *key = ST100Zones; key < ST100Zones + KEYCOUNT_ST100;
         key++) {
      Key translatedKey = *key;
      translatedKey.x += translatedKey.width / 2;
      translatedKey.y += translatedKey.height / 2;
  ...
  case KeyMap::IRONCLAW: {
    // M65 isn't a keyboard; all mouse maps are unique.
    for (const Key *key = IronclawKeys; key < IronclawKeys + KEYCOUNT_IRONCLAW;
         key++) {
      // Keyboard keys are written from the center because that's where the
      // LEDs are, but the mouse buttons are odd shapes so they're written
      // from the upper left
  ...
  case KeyMap::NIGHTSWORD: {
    ...
    for (const Key *key = NightswordKeys;
         key < NightswordKeys + KEYCOUNT_NIGHTSWORD; key++) {
      Key translatedKey = *key;
      translatedKey.x += translatedKey.width / 2;
      translatedKey.y += translatedKey.height / 2;
      map[key->name] = translatedKey;
  ...
  case KeyMap::IRONCLAW_W: {
    // M65 isn't a keyboard; all mouse maps are unique.
    for (const Key *key = IronclawWirelessKeys;
         key < IronclawWirelessKeys + KEYCOUNT_IRONCLAW_W; key++) {
      // Keyboard keys are written from the center because that's where the
      // LEDs are, but the mouse buttons are odd shapes so they're written
      // from the upper left
      Key translatedKey = *key;
...
KeyMap::Layout KeyMap::locale(QList<QPair<int, QString>> *layouts) {
  ...
  if (loc.startsWith("dk-"))
    ...
    layout = KeyMap::SE;
  else if (loc.startsWith("en-us") || loc.startsWith("en-au") ||
           loc.startsWith("en-ca") || loc.startsWith("en-hk") ||
           loc.startsWith("en-in") || loc.startsWith("en-nz") ||
           loc.startsWith("en-ph") || loc.startsWith("en-sg") ||
           loc.startsWith("en-za"))
...
const QStringList KeyMap::layoutList{"Danish",
...
KeyMap::KeyMap(Model _keyModel, Layout _keyLayout)
    : _keys(getMap(_keyModel, _keyLayout)), keyModel(_keyModel),
      keyLayout(_keyLayout), keyWidth(modelWidth(_keyModel)),
      keyHeight(modelHeight(_keyModel)) {}

KeyMap::KeyMap()
    : keyModel(NO_MODEL), keyLayout(NO_LAYOUT), keyWidth(0), keyHeight(0) {}
...
QString KeyMap::friendlyName(const QString &key, Layout layout) {
  ...
  // it would probably be best to remove the friendly names from the maps
  // and have a completely separate name->friendlyName store
  ...
  // Additionally, there are a handful of keys not present on any physical
  // keyboard, but we need names for them
